     ...
     body: Column(
       ...
       children: [
        ...
        SizedBox(height: 10,),
         ...
         SizedBox(height: 10,),
         Text("Ajith",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,),),
         Text("@ajith"),
         SizedBox(height: 10,),
