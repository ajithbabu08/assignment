...
var image=["https://i.scdn.co/image/ab67616d00001e026686e1c284707576239d78b9",
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(backgroundColor: Colors.black,
            floating: true,
            pinned: false,
            title: const Center(child: Text("Playlists",style: TextStyle(color: Colors.pink,fontWeight: FontWeight.bold),)),
            bottom: AppBar(
                ...
                child: const Padding(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      hintText: "Search...",
                      hintStyle: TextStyle(color: Colors.pink,fontWeight: FontWeight.bold),
